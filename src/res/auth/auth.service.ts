...
import { ChangePasswordDto, CreateUserDto, LoginUserDto, RegenrateOtpDto, VerifyUserDto } from './dto/auth.dto';
...
export class AuthService {
    ...
    async create(data: CreateUserDto){
        ...
        await this.createUserQueue.add({code, user}, {removeOnComplete: true, removeOnFail: true});
        return Response.success(null, "User created successfully",HttpStatus.CREATED);  
    }
    ...
    async verify(data: VerifyUserDto){
        ...
        return Response.success({user, token}, "Verification successful", HttpStatus.OK);
    }
    ...
    async regenerate(data: RegenrateOtpDto){
        ...
        return Response.success(null, "Otp code generated successfully",HttpStatus.OK);
    }
    ...
    async changePassword(data: ChangePasswordDto){
        ...
        return Response.success(null, "Password changed successfully", HttpStatus.OK);
    }
