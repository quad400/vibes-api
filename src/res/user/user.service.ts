...
export class UserService {
    ...
    async updateMe(data: UpdateUserDto, user: UserEntity) {
        ...
        return Response.success(updatedUser, "User updated successfully", HttpStatus.OK);
    }
    ...
    async followUnfollowUser(userId: string, followId: string) {
        ...
        if (existingFollow) {
            ...
            return Response.success(null, "User unfollowed successfully", HttpStatus.OK)
        }else{
            ...
            return Response.success(null, "User followed successfully", HttpStatus.OK)
        }
    ...
    async getFollowers(userId: string) {
        ...
        return Response.success(followers, "Followers fetched successfully", HttpStatus.OK)
    }
    ...
    async getFollowings(userId: string) {
        ...
        return Response.success(followings, "Following fetched successfully", HttpStatus.OK)
    }
